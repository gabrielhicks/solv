export const VERSION_TESTNET = '3.0.4'
export const VERSION_MAINNET = '2.3.10'
export const VERSION_JITO_TESTNET = '3.0.4'
export const VERSION_JITO_MAINNET = '2.3.10'
export const VERSION_JITO_RPC = '2.3.10'
export const VERSION_SOLANA_RPC = '2.3.10'
