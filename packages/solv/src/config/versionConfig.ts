...
export const VERSION_MAINNET = '3.1.8'
export const AGAVE_PATCH = ''
export const VERSION_JITO_TESTNET = '3.1.8'
export const VERSION_JITO_MAINNET = '3.1.8'
export const JITO_PATCH = ''
export const VERSION_BAM_TESTNET = '3.1.8'
export const VERSION_BAM_MAINNET = '3.1.8'
export const BAM_PATCH = ''
export const VERSION_JITO_RPC = '3.1.8'
export const VERSION_SOLANA_RPC = '3.1.8'
...
export const VERSION_FIREDANCER = '0.811.30108'
